...
/**
 * # Exceptions
 * - Throws RequiredPositiveDoubleValueException when @dt is less than or equal to zero
 * - Throws RequiredPositiveDoubleValueException when @city_size is less than or equal to zero
 * - Throws RequiredPositiveDoubleValueException when @recovery_time is less than or equal to zero
 */
City::City
(
