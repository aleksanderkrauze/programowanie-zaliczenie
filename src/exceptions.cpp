...
SimulationBaseException::SimulationBaseException(const std::string& msg) noexcept:
	m_msg {msg}
{}
...
OutOfCityBoundsException::OutOfCityBoundsException(const std::string& msg) noexcept:
	SimulationBaseException {msg}
{}

OutOfCityBoundsException::OutOfCityBoundsException(const Person& p, const double city_size) noexcept
{
		std::ostringstream s;
