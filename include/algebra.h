...
public:
  ...
  explicit Vector2d(const std::tuple<double, double>);
  ...
  void tuple(const std::tuple<double, double>);
  double length() const;
  ...
  Vector2d operator-(const Vector2d&) const;
  Vector2d operator*(const double) const;        // scalar multiplication
  double operator*(const Vector2d&) const; // dot product
  Vector2d& operator+=(const Vector2d&);
  Vector2d& operator-=(const Vector2d&);
  Vector2d& operator*=(const double); // scalar multiplication
